...
countdown count = "Ready!" ++ produceString count

produceString :: Integer -> String
produceString 0 = " Liftoff!"
produceString count = " " ++ show count ++ "..." ++ produceString (count - 1)
...
isPrime n
 | n < 2 = False
 | otherwise = if smallestDivisor n == n
               then True
               else False
